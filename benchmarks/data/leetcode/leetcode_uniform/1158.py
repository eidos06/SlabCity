...
item_id = random.choices(item_id_pool, k = total_order)
buyer_id = random.choices(user_id_pool, k = total_order)
seller_id = random.choices(user_id_pool,k = total_order)
