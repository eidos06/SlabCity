...
transformed_customer_id_pool = zipf_transform(customer_id_pool)
date_pool = zipf_transform(date_pool)
cost_pool = zipf_transform(cost_pool)
customer_name_pool = zipf_transform(customer_name_pool)
...
for i in range(total):
    pair = generate_pair(date_pool, transformed_customer_id_pool)
