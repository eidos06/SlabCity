...
transformed_d_id_pool = zipf_transform(d_id_pool)
...
for i in range(employee_num):
    employee_table.append([i, random.choice(transformed_d_id_pool), random.choice(e_name_pool), random.choice(salary_pool)])
